        ...
        <div class="row">
            <div class="col-12">
                <div class="card bg-primary py-0">
                    <h5 class="card-header text-white"><strong>Edit Data Absensi Tausiyah</strong></h5>
                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="umat_id" id="umat_id" required>
                                        ...
                                        @foreach ($tausiyahs as $tausiyah)
                                            <option value="{{ $tausiyah->id }}"
                                                {{ $tausiyah->id == $absensi->umat_id ? 'selected' : '' }}>
                                                {{ $tausiyah->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="ket" id="ket"
                                        value="{{ $absensi->ket }}" placeholder="Opsional">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="pengisi" id="pengisi"
                                        value="{{ $absensi->pengisi }}" required>
                                </div>
                            </div>
