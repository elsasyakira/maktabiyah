                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr class="border-transparent">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm me-4">
                                                    <img src="{{ asset('mat/assets/img/avatars/1.png') }}" alt="Avatar" class="rounded-circle" />
                                                </div>
                                                <div>
                                        ...
                                        <td class="text-truncate"><i class="ri-user-3-line ri-22px text-success me-2"></i>{{ $user->role }}</td>
