<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-semibold ms-2">Maktabiyah</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @if (Auth::user()->role == 'syubah' || Auth::user()->role == 'jamiah')
            <li class="menu-item">
                <a href="#" class="menu-link">
                    <i class="menu-icon tf-icons ri-user-line"></i>
                    <div data-i18n="User">Laporan Absensi</div>
                </a>
            </li>
            <!-- Absensi -->
        @endif
        ...
        <!-- Components -->
        <li class="menu-header mt-7"><span class="menu-header-text">Setings</span></li>
        <!-- Cards -->
        <li class="menu-item">
            <a href="{{ route('profile') }}" class="menu-link">
                <i class="menu-icon tf-icons ri-account-circle-line"></i>
                <div data-i18n="User">My Profile</div>
            </a>
        </li>
        <li class="menu-item">
            ...
            <a href="" class="menu-link"
                ...
                <i class="menu-icon tf-icons ri-shut-down-line"></i>
